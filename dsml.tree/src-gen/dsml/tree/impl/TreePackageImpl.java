...
public class TreePackageImpl extends EPackageImpl implements TreePackage {
	...
	public static TreePackage init() {
		...
		TreePackageImpl theTreePackage = (TreePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof TreePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new TreePackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getTree_Root(), this.getNode(), null, "root", null, 1, 1, Tree.class, !IS_TRANSIENT,
